...
const dict = {
  ...
  fileComplaint: { en: 'File a Complaint', mr: 'तक्रार नोंदवा', hi: 'शिकायत दर्ज करें' },
  trackComplaint: { en: 'Track Complaint', mr: 'तक्रार तपासा', hi: 'शिकायत ट्रैक करें' },
  ...
  heroTitle1: { en: 'Your Complaint.', mr: 'आपली तक्रार.', hi: 'आपकी शिकायत.' },
  ...
  complaintSummary: { en: 'Complaint Summary', mr: 'तक्रार सारांश', hi: 'शिकायत सारांश' },
  ...
  submitComplaint: { en: 'Submit Complaint', mr: 'तक्रार सादर करा', hi: 'शिकायत जमा करें' },
  newChat: { en: 'Start New Chat', mr: 'नवीन सुरुवात करा', hi: 'नई शुरुआत करें' },
  filedAnonymously: { en: 'File anonymously', mr: 'तक्रार गुप्तपणे नोंदवा', hi: 'गुमनाम रूप से दर्ज करें' },

  trackTitle: { en: 'Track Your Complaint', mr: 'तुमची तक्रार तपासा', hi: 'अपनी शिकायत ट्रैक करें' },
  enterTrackingId: { en: 'Enter your Complaint ID (e.g. AMC-2026-000123)', mr: 'तुमचा तक्रार ID टाका (उदा. AMC-2026-000123)', hi: 'अपनी शिकायत आईडी दर्ज करें (जैसे AMC-2026-000123)' },
  ...
  servicesTitle: { en: 'File a Complaint By Category', mr: 'श्रेणीनुसार तक्रार नोंदवा', hi: 'श्रेणी के अनुसार शिकायत दर्ज करें' },
  servicesSub: {
  ...
  fileComplaintLink: { en: 'File complaint', mr: 'तक्रार नोंदवा', hi: 'शिकायत दर्ज करें' },
  ...
  step2Sub: {
    en: 'AI instantly categorises your complaint and routes it to the right AMC department.',
    mr: 'AI तुमची तक्रार त्वरित वर्गीकृत करून योग्य AMC विभागाकडे पाठवते.',
    hi: 'AI आपकी शिकायत को तुरंत वर्गीकृत करके सही AMC विभाग को भेजता है.',
  },
  step3Title: { en: 'Track Live Status', mr: 'थेट स्थिती तपासा', hi: 'लाइव स्थिति ट्रैक करें' },
  step3Sub: {
    en: 'Get a unique Complaint ID and follow every update in real time from submission to resolution.',
    mr: 'एक अनन्य तक्रार ID मिळवा आणि सादरणीपासून निराकरणापर्यंत प्रत्येक अपडेट रिअल टाइममध्ये फॉलो करा.',
    hi: 'एक अनोखी शिकायत ID पाएं और सबमिशन से समाधान तक हर अपडेट को रियल टाइम में फ़ॉलो करें.',
  },

  // Stats
  stat1Label: { en: 'Complaints Resolved', mr: 'तक्रारी निराकरण', hi: 'शिकायतें हल' },
  ...
  allComplaints: { en: 'All Complaints', mr: 'सर्व तक्रारी', hi: 'सभी शिकायतें' },
  totalComplaints: { en: 'Total Complaints', mr: 'एकूण तक्रारी', hi: 'कुल शिकायतें' },
  ...
  complaintsByDept: { en: 'Complaints by Department', mr: 'विभागनिहाय तक्रारी', hi: 'विभाग अनुसार शिकायतें' },
  ...
  noComplaintsFound: { en: 'No complaints found.', mr: 'कोणत्याही तक्रारी आढळल्या नाहीत.', hi: 'कोई शिकायत नहीं मिली.' },
